 ...
 */
exports.customHelp = function(generator, cmd, usageFilePath) {
  var command = cmd || helpers.getCommandName();

  // Build usage
  var helpStr = [
    'Usage:',
    ' ' + exports.usageBuild(generator),
    '',
  ];
  ...
  if (Object.keys(generator._options).length) {
    helpStr = helpStr.concat([
      'Options:',
      exports.optionsBuild(generator),
      '',
    ]);
  }
  ...
  if (generator._arguments.length) {
    helpStr = helpStr.concat([
      'Arguments:',
      exports.argumentsBuild(generator),
      '',
    ]);
  }
...
exports.usageBuild = function(generator) {
  var options = Object.keys(generator._options).length ? '[options]' : '';
 ...
 * Build options
 */
exports.optionsBuild = function(generator) {
 ...
 */
exports.argumentsBuild = function(generator) {
